...
{
	{ TEXT("All Systems"),     "allgames",          FOLDER_ALLGAMES,     IDI_FOLDER,               0,             0,            NULL,                       NULL,                    TRUE },
	{ TEXT("Available"),       "available",         FOLDER_AVAILABLE,    IDI_FOLDER_AVAILABLE,     F_AVAILABLE,   0,            NULL,                       FilterAvailable,         TRUE },
	{ TEXT("Unavailable"),     "unavailable",       FOLDER_UNAVAILABLE,  IDI_FOLDER_UNAVAILABLE,   0,             F_AVAILABLE,  NULL,                       FilterAvailable,         FALSE },
	{ TEXT("Console"),         "console",           FOLDER_CONSOLE,      IDI_FOLDER,               F_CONSOLE,     F_COMPUTER,   NULL,                       DriverIsConsole,         TRUE },
	{ TEXT("Computer"),        "computer",          FOLDER_COMPUTER,     IDI_FOLDER,               F_COMPUTER,    F_CONSOLE,    NULL,                       DriverIsComputer,        TRUE },
	{ TEXT("Modified/Hacked"), "modified",          FOLDER_MODIFIED,     IDI_FOLDER,               0,             0,            NULL,                       DriverIsModified,        TRUE },
...
//	{TEXT("CPU"),             "cpu",               FOLDER_CPU,          IDI_FOLDER,               0,             0,            CreateCPUFolders },
//	{TEXT("Sound"),           "sound",             FOLDER_SND,          IDI_FOLDER,               0,             0,            CreateSoundFolders },
...
//	{TEXT("BIOS"),            "bios",              FOLDER_BIOS,         IDI_FOLDER,               0,             0,            CreateBIOSFolders,          DriverIsBios,            TRUE },
	...
	{ TEXT("Mouse"),           "mouse",             FOLDER_MOUSE,        IDI_FOLDER,               0,             0,            NULL,                       DriverUsesMouse,         TRUE },
